  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setForm({
        ...
        previousPrice: product.previousPrice != null ? String(product.previousPrice) : "",
  ...
  if (notFound) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/admin/productos" className="text-primary-600 hover:text-primary-700 text-sm">
          Volver a productos
        </Link>
      </div>
    );
