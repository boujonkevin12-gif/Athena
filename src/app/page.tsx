      ...
      <main className="flex-1">
        ...
        <section className="bg-white py-20 lg:py-28">
          <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 text-center">
            <span className="inline-block text-[11px] font-medium uppercase tracking-[0.2em] text-[#C07D5E] mb-4">
              Contacto
            </span>
            <h2 className="font-display text-[36px] lg:text-[44px] font-light text-[#1a1a1a] mb-4">
              ¿Tenés alguna consulta?
            </h2>
            <p className="text-[#1a1a1a]/40 text-[15px] mb-10 max-w-md mx-auto font-light">
